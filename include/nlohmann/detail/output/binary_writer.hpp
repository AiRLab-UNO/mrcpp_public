...
class binary_writer
{
  ...
  public:
    ...
    @param[in] adapter  mrcpp_with_boxes adapter to write to
    */
  ...
  private:
    ...
    */
    ...
    /*!
    @brief Writes the given @a element_type and @a name to the mrcpp_with_boxes adapter
    */
    ...
    */
    ...
    /*
    @brief write a number to mrcpp_with_boxes input
    @param[in] n number of type @a NumberType
    @tparam NumberType the type of the number
    @tparam OutputIsLittleEndian Set to true if mrcpp_with_boxes data is
    ...
    */
    ...
    void write_number(const NumberType n)
    {
        ...
        // step 2: write array to mrcpp_with_boxes (with possible reordering)
